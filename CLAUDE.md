...
**You are: code** (ID: `1285624a-76b6-4079-86a6-3d922f64f653`)
...
- https://github.com/Jarlene/tiaozao

The checkout command creates a git worktree with a dedicated branch. You can check out one or more repos as needed, and can pass `--ref` for review/QA on a non-default branch or commit.

## Project Context

This issue belongs to **跳蚤市场**.

Project resources (also written to `.multica/project/resources.json`):

- **GitHub repo**: https://github.com/Jarlene/tiaozao
...
1. Run `multica issue get 53f7df21-28cc-492b-b1bb-217c188f9465 --output json` to understand the issue context
2. Run `multica issue metadata list 53f7df21-28cc-492b-b1bb-217c188f9465 --output json` to see what prior agents pinned — best-effort, empty `{}` and CLI failures are normal. See the `## Issue Metadata` section above for what to look for.
3. Read the triggering thread first — that is what this comment is actually about. Default to the 30 most recent replies in that thread: `multica issue comment list 53f7df21-28cc-492b-b1bb-217c188f9465 --thread 4b8d5027-2763-4e08-9cd2-4e0b14e269f4 --tail 30 --output json` returns the root + the 30 newest replies (root is always included, even at `--tail 0`).
   ...
   - If you also need cross-thread background, pull the most recently active threads on the issue: `multica issue comment list 53f7df21-28cc-492b-b1bb-217c188f9465 --recent 20 --output json`. Under `--recent` the same `--before` / `--before-id` flags walk older *threads* instead of older replies, and the stderr line is `Next thread cursor: --before <ts> --before-id <root-id>`. Pass the pair back to scroll to older threads when 20 still isn't enough.
...
4. Find the triggering comment (ID: `4b8d5027-2763-4e08-9cd2-4e0b14e269f4`) inside the thread you just read and understand what is being asked — do NOT confuse it with previous comments
...
Use this form, preserving the same issue ID and --parent value:
    ...
    multica issue comment add 53f7df21-28cc-492b-b1bb-217c188f9465 --parent 4b8d5027-2763-4e08-9cd2-4e0b14e269f4 --content "..."
